...
public class FavGameResponse {
    ...
    public FavGameResponse(int gameId, LocalDateTime start, String homeTeamName, String homeTeamLogo,String homeColour ,
